...
const MaterialSelector = ({ selectedVariant, onVariantChange }) => {
  ...
  const availableColors = selectedShape
    ? getAvailableVariantsByShape(selectedShape)
    : [];
      ...
      {step === 1 && (
        <div>
          ...
          <p className="text-gray-400 mb-6">
            Select the tag style that fits your pet's collar
          </p>
        ...
        <div>
          ...
          <h3 className="text-2xl font-bold text-white mb-2">
            ...
            <span className="text-gray-500 ml-2">
              ({getShapeById(selectedShape)?.displayName})
            </span>
          </h3>
          <p className="text-gray-400 mb-6">
              ...
              >
                ...
                <div className="aspect-square bg-neutral-100 relative flex items-center justify-center p-4">
                  <img
                    src={variant.image}
                    alt={`${variant.color} ${
                      getShapeById(selectedShape)?.name
                    }`}
